defmodule CambiatusWeb.Schema.Subscriptions.NotificationsTest do
  use CambiatusWeb.SubscriptionCase

  alias Cambiatus.Notifications.NotificationHistory
  ...
  describe "Notifications Subscriptions" do
    ...
    test "Can be subscribed to", %{socket: socket} do
      ...
      Absinthe.Subscription.publish(CambiatusWeb.Endpoint, payload, unreads: user.account)
