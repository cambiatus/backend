defmodule BeSpiralWeb.Schema.AccountTypes do
  @moduledoc """
  This module holds objects, input objects, mutations and queries used with the Accounts context in `BeSpiral`
  use it to define entities to be used with the Accounts Context
  """
  use Absinthe.Schema.Notation
  use Absinthe.Relay.Schema.Notation, :classic
  import Absinthe.Resolution.Helpers, only: [dataloader: 1]
  alias BeSpiralWeb.Resolvers.Accounts
  ...
  object :profile do
    ...
    field(:communities, list_of(:community), resolve: dataloader(BeSpiral.Commune))
