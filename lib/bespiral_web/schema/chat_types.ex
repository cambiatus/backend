defmodule BeSpiralWeb.Schema.ChatTypes do
  @moduledoc """
  This module holds objects, input objects, mutations and queries used with the Chat context in `BeSpiral`
  use it to define entities to be used with the Chat Context
  """
  use Absinthe.Schema.Notation

  alias BeSpiralWeb.Resolvers.Chat
