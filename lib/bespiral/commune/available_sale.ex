defmodule BeSpiral.Commune.AvailableSale do
  @moduledoc """
  This module holds the data structure that represents an instance of a `BeSpiral.Commune.AvailableSale` use it to
