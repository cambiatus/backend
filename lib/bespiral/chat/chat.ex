defmodule BeSpiral.Chat do
  @moduledoc "BeSpiral Chat manager"

  alias BeSpiral.Accounts.User
  alias BeSpiral.Validator

  @chat_api Application.get_env(:bespiral, :chat_api)
  ...
  Examples:
  BeSpiral.Chat.sign_up(%BeSpiral.Accounts.User{account: "user1", email: "user1@email.com"})
  """
  ...
  Examples:
  BeSpiral.Chat.sign_in(%BeSpiral.Accounts.User{account: "user1"})
  """
  ...
  Examples:
  BeSpiral.Chat.get_preferences(%{"user_id" => "any_user_id", "token" => "valid_token"})
  """
  ...
  Examples:
  BeSpiral.Chat.change_language(%{"user_id" => "any_user_id", "language" => "language_in_iso_format"})
  """
